...
<div class="date-time">
  ...
  <a class="active"href="ListEmployee_Dept.php">Employee List</a>
          ...
          $status = "ABSENT";
           ...
           ?>
            <tr>
                ...
                <button type="button" onclick="location.href='setschedule.php?id=<?php echo $row['id']?>'" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                Set Schedule
              </button>
            </td>
          </tr>
...
<select name="leave" class="form-control" id="leave-dropdown">
            <option  value="0">Select Type of Vacation</option>
